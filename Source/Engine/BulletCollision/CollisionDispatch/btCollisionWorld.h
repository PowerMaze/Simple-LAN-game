...
public:
	...
	// added to prevent bullets/shells from damaging the owner
	struct IgnoreUserPointerRayCallback : public btCollisionWorld::ClosestRayResultCallback {
		void* m_ignoredPointer;

		IgnoreUserPointerRayCallback(const btVector3& from, const btVector3& to, void* ignoredPtr)
			: btCollisionWorld::ClosestRayResultCallback(from, to), m_ignoredPointer(ignoredPtr) {}

		bool needsCollision(btBroadphaseProxy* proxy0) const override {
			btCollisionObject* obj = static_cast<btCollisionObject*>(proxy0->m_clientObject);

			if (obj && obj->getUserPointer() == m_ignoredPointer)
				return false; // ignore this object
